const experiences = [
  {
    ...
    description: (
      <ul>
        <li>
          I am actively looking for full-time positions in software engineering
          upon my graduation in May 2025.
        </li>
        <li>
          If you are hiring software engineers or have exciting projects, please
          reach out.
        </li>
      </ul>
    ),
  ...
  },
  {
    ...
    description: (
      <ul>
        <li>
          Led weekly lab sessions for 40+ students, clarifying software
          construction concepts and addressing technical questions.
        </li>
        <li>
          Provided one-on-one support during office hours, assisting with
          project implementation and course content.
        </li>
        <li>
          Graded assignments, ensuring code quality and adherence to best
          practices.
        </li>
      </ul>
    ),
  ...
  },
  {
    ...
    description: (
      <ul>
        <li>
          Developed an application to streamline the recruitment process for
          student clubs.
        </li>
        <li>
        ...
        <li>
          Conducted peer code reviews to guarantee best practices and
          functionality.
        </li>
      </ul>
    ),
